                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1>Información Deuda Pendiente</h1>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <span style="font-size:14px"><span style="font-family:verdana,geneva,sans-serif">Estimado <strong>{{ $nombre }}</strong>:<br>
Informamos que el jugador <strong>{{ $jugador }}</strong><br>
registra una deuda pendiente por <strong><span style="color:#FF0000">{{ $deuda }}</span></strong> en el periodo <strong>{{ $periodo }}</strong><br>
<br>
Solicitamos su cancelación y posterior confirmación al correo&nbsp;<a href="mailto:clubquinta@quinta.cl" target="_blank">clubquinta@quinta.cl</a><br>
o bien informar el pago usando la plataforma en&nbsp;</span></span><a href="http://quinta.myclub.cl" target="_blank"><span style="font-size:14px"><span style="font-family:verdana,geneva,sans-serif">quinta.myclub.cl</span></span></a><br>
&nbsp;
                        </td>
                    </tr>
                </tbody></table>
